                  ...
                  <div class="form-wrapper">
                     <div class="widget">
                        <div class="widget-body">
                           ...
                           <form action="" name="submit" method="post" class="login-form">
                              <?php
                              $pid=$_SESSION['fosuid'];
                              ...
                              <div class="">
                                 ...
                                 <div class="form-bind">
                                    ...
                                    <input type="email" class="form-control" id="email" aria-describedby="emailHelp"
                                       ...
                                       required="true" readonly='true'> <small id="emailHelp"
                                 ...
                                 <div class="form-bind">
                                    ...
                                    <input class="form-control" type="text" id="mobilenumber" name="mobilenumber"
                                       value="<?php  echo $row['MobileNumber'];?>" readonly="true"> <small
                                       class="form-text text-muted">We"ll never share your mobile number with anyone
                                       else.</small>
                                 </div>
                                 <div class="form-bind">
