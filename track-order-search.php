    ...
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
       ...
       <?php include_once('includes/header.php');?>
        ...
        <div class="page-wrapper">
            ...
            <!-- //results show -->
            <section class="restaurants-page" style="padding:50px; 0">
                <div class="container">
                    <div class="order-row">
                        <div class="menu">
                            <div class="sidebar">
...
$orderno=$_POST['ordernumber'];
      ...
      if($result=='0'){ ?>
<div class="row" style="margin-left:50px; background:white; position:relative; z-index:9999">
<div class="text-sm-left" style="padding:30px">
No Record found against this order number.
       ...
       <?php }else {
              while($row=mysqli_fetch_array($query))
              { ?>                  
                                <div class="order-id" style="margin-left:50px; background:white; position:relative; z-index:9999">
                                    <div class="order">
