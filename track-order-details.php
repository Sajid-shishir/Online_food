...
?>
                                    ...
                                    <div class="order-items">
                                        <div class="order-content">
                                            <div class="rest-logo">
                                                <a class="restaurant-logo" href="#"><img src="admin/itemimages/<?php echo $row['Image']?>" width="100" height="80" alt="<?php echo $row['ItemName']?>"></a>
                                            </div>
                                            <!-- end:Logo -->
...
<h6><a href="food-detail.php?fid=<?php echo $_SESSION['fid']=$row['FoodId'];?>"><?php echo $row['ItemName']?> (<?php echo $row['ItemQty']?>) </a></h6>
                                        ...
                                        <!-- end:col -->
                                        <div class="item-cart-info"> <span class="order-price">Taka. <?php echo $total=$row['ItemPrice']?></span></div>
                                    </div>
                                    <!-- end:row -->
