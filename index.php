        ...
        <div class="container">
            <div class="banner-wrapper">
                <div class="banner-left">
                    ...
                    <p>Find your favourite delicious food!</p>
                    ...
                    <div class="step-item step3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 612.001 612">
                            <path
                                ...
                                fill="#FFF" /> </svg>
                        <h4><span>3. </span> Get Delivery</h4>
                    </div>
                    <!-- end:Step -->
                </div>
                <!-- end:Steps -->
    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="section-head">
                <h2 style="color: Green"  class="section-title"> Have A Look On Our Popular Foods... </h2>
...
?>
    ...
    <section class="how-it-works">
        <div class="container">
            <div class="section-head">
                <h2 class="section-title">Easy 3 Steps Order</h2>
            </div>
            ...
            <div class="steps-wrapper">
                ...
                <div class="single-steps">
                    <div class="step step-3">
                        ...
                        <h3>Get Delivery</h3>
                        <p>Get your food delivered! And enjoy your meal! <br> Use Cash on delivery or Pay through bKash</p>
                    </div>
                </div>
            ...
            <div class="step-bottom">
                <p class="pay-info">Pay by Cash on delivery or By Your BKash</p>
            </div>
        </div>
    </section>
