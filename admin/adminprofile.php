...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
    $toast="<span class='alert alert-success'><strong>Success: </strong>Admin profile has been updated.</span>";
  }
  else
    {
      $toast="<span class='alert alert-success'><strong>Error: </strong>Something Went Wrong. Please try again.</span>";
    }
  }
  ?>
<!DOCTYPE html>
                                ...
                                <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                        ...
                                        <div class="form-group row"><label
                                                class="col-sm-2 col-form-label">MobileNumber:</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row"><label
                                            ...
                                            <div class="col-sm-10"><input type="email" class="form-control" name="email"
                                                    required="true" value="<?php  echo $row['Email'];?>"></div>
                                        </div>
                                        <!-- <div class="form-group row"><label class="col-sm-2 col-form-label">Admin
                                                Registration date:</label>
                                            <div class="col-sm-10"><input type="text" class="form-control"
                                                    name="adminrd" readonly="true"
                                                    value="<?php  echo $row['AdminRegdate'];?>"></div>
                                        </div> -->
