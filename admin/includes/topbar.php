    <nav class="topbar-default topbar-static-side" role="navigation">
        <div class="topbar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="dashboard.php" style="color:#007bff;"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span> <span class="fa arrow"></span></a>
                                    </li>
                                    <li>
                    <a href="user-detail.php" style="color:#007bff;"><i class="fa fa-users"></i> <span class="nav-label">Reg Users</span> <span class="fa arrow"></span></a>
                                    </li>
                ...
                <li>
                    <a href="#"  style="color:#007bff;"><i class="fa fa-edit"></i> <span class="nav-label">Food Category</span><span class="fa arrow"></span></a>
 ...
 <li>
                    <a href="#" style="color:#007bff;"><i class="fa fa-edit"></i> <span class="nav-label">Food Menu</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                   ...
                   <li>
                    <a href="#" style="color:#007bff;"><i class="fa fa-file"></i> <span class="nav-label">Reports</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
