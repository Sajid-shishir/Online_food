...
if(isset($_POST['submitDelItem'])){
    $cid = $_GET['editid'];
    $query = mysqli_query($con,"DELETE FROM tblcategory WHERE id=$cid");
    if ($query) {
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <div class="form-group" style="text-align: center">
                                                    ...
                                                    <button type="submit" name="submitDelItem" class="btn btn-danger"
                                                        onclick="return confirm('Do you really like to Delete this item?');">Delete</button>
                                                </div>
