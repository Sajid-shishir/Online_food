            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="manage-foodcategory.php">Item Name</a>
                        </li>
                            ...
                            <div class="ibox-content">
                                ...
                                echo $msg;
                                    ...
                                    <p style="text-align: center;">
                                        <button type="submit" name="submitDelItem"
                                            class="btn btn-danger" onclick="return confirm('Do you really like to Delete this item?');">Delete</button>
