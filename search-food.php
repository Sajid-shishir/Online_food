                            ...
                            <div class="items-wrapper">
                                ...
                                <div class="food-item">
                                    <div class="food-item-wrap">
                                        <div class="food-img"> <img src="admin/itemimages/<?php echo $row['Image'];?>" width="300" height="180">
                                ...
                                <div class="content">
                                    ...
                                    <div class="price-btn-block"> <?php if($_SESSION['fosuid']==""){?>
                                         <a href="login.php" class="custom-btn">Add to Cart</a>
                                         <?php } else {?>
                                             <form method="post"> 
                                             <input type="hidden" name="foodid" value="<?php echo $row['ID'];?>">   
                                         <button type="submit" name="submit" class="custom-btn"> Add to cart</button>
                                           </form> 
                                         <?php }?>
                                    </div>
                                </div>                                 
